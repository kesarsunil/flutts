...
class _LoginPageState extends State<LoginPage> {
  ...
  void setAdminMode(bool isAdmin) {
    setState(() {
      isAdminMode = isAdmin;
      isSignIn = true; // Always show sign in when switching modes
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: isAdminMode
          ? AdminSignInPage(onBackToSelection: () => setAdminMode(false))
          : (isSignIn
                ? UserSignInPage(
...
class AdminSignInPage extends StatefulWidget {
  ...
  const AdminSignInPage({super.key, required this.onBackToSelection});
    ...
    return Container(
      decoration: BoxDecoration(
        image: const DecorationImage(
          image: AssetImage('assets/images/hhhhhh-removebg-preview.png'),
          fit: BoxFit.cover,
          opacity: 0.3,
        ),
        gradient: LinearGradient(
